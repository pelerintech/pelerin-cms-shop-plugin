...
const TEST_FILES = [
  ...
  'tests/lib/data/attribute-value.test.ts',
  'tests/lib/data/attribute-values.test.ts',
  'tests/lib/data/attribute-options-labels.test.ts',
  'tests/lib/data/options-uniqueness.test.ts',
  'tests/lib/data/categories-search.test.ts',
  'tests/lib/data/categories-pagination.test.ts',
  'tests/lib/data/products-type-filter.test.ts',
  'tests/lib/data/vouchers-type-filter.test.ts',
  ...
  'tests/lib/data/orders-metadata.test.ts',
  'tests/lib/data/orders-user-filter.test.ts',
  ...
  'tests/api/handlers/public/checkout/notes.test.ts',
  'tests/api/handlers/public/checkout/metadata.test.ts',
  ...
  'tests/pages/admin-pagination-component.test.ts',
  'tests/pages/admin-products-list-ui.test.ts',
  'tests/pages/admin-products-script-syntax.test.ts',
  'tests/pages/admin-vouchers-list-ui.test.ts',
  'tests/pages/admin-vouchers-id-units.test.ts',
  ...
  'tests/pages/admin-attributes-form.test.ts',
  'tests/pages/admin-referral-id-units.test.ts',
  'tests/pages/admin-referral-id-script-syntax.test.ts',
  'tests/pages/admin-orders-partial-refund.test.ts',
  'tests/pages/admin-money-display-units.test.ts',
  ...
  'tests/pages/admin-order-metadata-ui.test.ts',
