...
import { transitionOrder, validateTransition, OrderTransitionError } from '../../src/lib/order-transitions.ts';
...
async function makeOrder(db: any, f: any, orderNumber: string, status: string) {
  ...
  const order = await createOrder(db, {
    order_number: orderNumber, user_id: null, customer_type: 'individual', customer_email: 't@e.com',
