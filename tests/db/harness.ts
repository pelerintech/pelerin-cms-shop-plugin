...
export async function seedMinimal(db: LibSQLDatabase<typeof schema>): Promise<Fixtures> {
  ...
  await db.insert(products).values([
    {
      ...
      active: true,
      name: 'Carte de programare',
      description: 'O carte excelentă',
      slug: 'carte-programare',
      created_at: now,
      updated_at: now,
    },
    {
      id: f.variantProductId,
      sku: null,
      type: 'physical',
      has_variants: true,
      vat_rate: 0.19,
      ...
      active: true,
      name: 'Telefon Smart X',
      description: 'Telefon inteligent',
      slug: 'telefon-smart-x',
      created_at: now,
      updated_at: now,
    },
  ]);
  ...
  await db.insert(product_attribute_assignments).values([
    {
      id: f.assignSimpleBrandId,
      product_id: f.simpleProductId,
      attribute_id: f.attrBrandId,
      role: 'field',
      sort_order: 1,
      offered_option_ids: '[]',
    },
    {
      id: f.assignSimpleWeightId,
      product_id: f.simpleProductId,
      attribute_id: f.attrWeightId,
      role: 'field',
      sort_order: 2,
      offered_option_ids: '[]',
    },
    {
      id: f.assignVariantColorId,
  ...
  await db.insert(product_attribute_values).values([
    ...
    },
    {
      ...
      entity_type: 'product',
      entity_id: f.simpleProductId,
      assignment_id: f.assignSimpleWeightId,
      option_id: null,
      value_text: null,
      value_number: 0.5,
      value_boolean: null,
    },
    {
      ...
      entity_type: 'product',
      entity_id: f.variantProductId,
      assignment_id: f.assignVariantBrandId,
      option_id: null,
      value_text: 'SmartTech',
      value_number: null,
      value_boolean: null,
    },
  ]);
  ...
  await db.insert(product_attribute_values).values([
    {
      ...
      assignment_id: f.assignVariantColorId,
    ...
    },
    {
      ...
      entity_type: 'variant',
      entity_id: f.variantBlack128Id,
      assignment_id: f.assignVariantStorageId,
      option_id: f.optStorage128Id,
      value_text: null,
      value_number: null,
      value_boolean: null,
    },
    {
      id: rid(),
      entity_type: 'variant',
      entity_id: f.variantWhite256Id,
      assignment_id: f.assignVariantColorId,
      option_id: f.optColorWhiteId,
      value_text: null,
      value_number: null,
      value_boolean: null,
    },
...
export function buildOrderRow(overrides: Record<string, any> = {}): Record<string, any> {
  return {
